...
import com.logicline.mydining.ui.adapter.UserInitiateAdapter
...
class InitiateMemberActivity : BaseActivity() {
    ...
    private fun initViews() {
        ...
        initiateUserAdapter =
            UserInitiateAdapter(this, initiateUser, UserInitiateAdapter.Type.INITIATE)
        notInitiateUserAdapter =
            UserInitiateAdapter(this, notInitiateUser, UserInitiateAdapter.Type.NOT_INITIATE)

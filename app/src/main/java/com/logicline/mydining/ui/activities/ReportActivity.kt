...
import com.logicline.mydining.ui.adapter.ReportAdapter
...
class ReportActivity : BaseActivity() {
    ...
    private fun checkStoragePermission() {
        when {ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED -> {

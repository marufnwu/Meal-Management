...
import dev.maruf.monthpicker.listener.DateMonthDialogListener;
import dev.maruf.monthpicker.listener.OnCancelMonthDialogListener;
...
public class JMonthPicker {

    private AlertDialog mAlertDialog;
    private JMonthPicker.Builder builder;
    ...
    public JMonthPicker(Context context) {
        this.context = context;
        builder = new Builder();
    }

    public JMonthPicker(Activity activity) {
     ...
     * @return
     */
    public JMonthPicker setPositiveButton(DateMonthDialogListener dateMonthDialogListener) {
     ...
     * @return
     */
    public JMonthPicker setNegativeButton(OnCancelMonthDialogListener onCancelMonthDialogListener) {
     ...
     * @return
     */
    public JMonthPicker setPositiveText(String text) {
     ...
     * @return
     */
    public JMonthPicker setNegativeText(String text) {
     ...
     * @return
     */
    public JMonthPicker setLocale(Locale locale) {
     ...
     * @return
     */
    public JMonthPicker setSelectedMonth(int month) {
     ...
     * @return
     */
    public JMonthPicker setSelectedYear(int year) {
     ...
     * @return
     */
    public JMonthPicker setColorTheme(int color) {
        builder.setColorTheme(color);
        return this;
    }

    public JMonthPicker setMonthType(MonthType monthType) {
